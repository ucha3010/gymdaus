...
CREATE TABLE `age_category` (
  `id` bigint(20) NOT NULL,
  `end_age` datetime(6) DEFAULT NULL,
  `gym_more_registration_id` bigint(20) DEFAULT NULL,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `position` int(11) NOT NULL,
  `start_age` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `change_low_sequence` VALUES (103);
...
CREATE TABLE `enrollment_more_data` (
  ...
  `poomsae` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `gym_belt` VALUES (20,'Blanco',1,0),(22,'Amarillo',1,1),(24,'Marrón',1,3),(31,'123456789012345678901234567890',2,0),(39,'Verde',1,2);
...
CREATE TABLE `gym_category` (
  ...
  `end_age` datetime(6) DEFAULT NULL,
  `end_belt_id` bigint(20) DEFAULT NULL,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `poomsae_id` bigint(20) DEFAULT NULL,
  `position` int(11) NOT NULL,
  `start_age` datetime(6) DEFAULT NULL,
  `start_belt_id` bigint(20) DEFAULT NULL,
  `gym_more_registration_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gym_more_registration_participating_entity` (
  ...
  `position` int(11) NOT NULL,
  `registration_date` datetime(6) NOT NULL,
  `registration_user` datetime(6) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `gym_poomsae` VALUES (27,1,'2º Poomsae - Taeguk i chang',1),(28,1,'3º Poomsae - Taeguk sam chang',2),(29,1,'1º Poomsae - Taeguk il chang',0),(30,2,'123456789012345678901234567890',0),(40,1,'4º Poomsae - Taeguk sa chang',3);
...
INSERT INTO `participating_entity` VALUES (74,2,'La cueva de arriba','Es un sucucho donde practican pesos los gordos con olor a cebolla podrida',0),(75,2,'La otra casa','',1),(76,2,'El aljibe','Un espectacular lugar, muy refinado, para ir a pasar un momento de relax junto con tus amigos y seres queridos',2);
...
-- Dump completed on 2024-12-10 13:12:19
